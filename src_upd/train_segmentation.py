...
from create_dataset_for_segmentation import (create_loaders_for_segmenatation,
                                             create_fold_from_data)
...
def main():
    ...
    for test_fold in config.test_folds:
        ...
        train_loader, valid_loader = create_loaders_for_segmenatation(data=data,
                                                                      test_fold=test_fold,
...
if __name__ == '__main__':
    ...
    with open("my_configs/config.yaml", "r") as f:
